...
const polarityStyles: Record<Polarity, { border: string; bg: string; text: string; icon: any; glow: string }> = {
...
export function IntelligenceCard({ data, onLongPress, onClick, onDismiss }: IntelligenceCardProps) {
